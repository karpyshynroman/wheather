...
function AppShell() {
  ...
  return (
    <div className="min-h-screen px-4 py-5 sm:px-6">
      <main
        className="mx-auto flex min-h-[calc(100vh-2.5rem)] w-full max-w-xl flex-col justify-center"
        data-provider={providerId}
      >
        <section className="relative overflow-hidden rounded-[2.25rem] border border-white/10 bg-slate-950/60 p-4 shadow-glow backdrop-blur-xl sm:p-6">
          <div
            ...
            <header className="space-y-3">
              ...
              <div>
                <h1 className="font-display text-4xl font-semibold tracking-tight text-white sm:text-5xl">
                  Weather, tuned to the provider.
                </h1>
                <p className="mt-3 max-w-prose text-sm leading-7 text-white/62 sm:text-base">
                  Input a location, switch providers, and the view updates immediately. The layout changes with the selected source so the interface stays legible and distinct.
                </p>
              </div>
            </header>
